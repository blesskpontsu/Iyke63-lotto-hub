...
use App\Http\Controllers\Callbacks\ProcessPaystack2Payloads;
...
Route::post('paystack-webhooks', [ProcessPaystack2Payloads::class, 'handle'])->middleware('paystack-api2');
