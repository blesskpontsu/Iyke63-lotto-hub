...
class Subscribe extends Component
{
    ...
    public function momoSubscription()
    {
        ...
        $invoiceEndDate = match ($plan->interval) {
            '91' => Carbon::now()->addDay()->format('Y-m-d\TH:i:s'),
            '182' => Carbon::now()->addDay()->format('Y-m-d\TH:i:s'),
            '360' => Carbon::now()->addDay()->format('Y-m-d\TH:i:s'),
            default => Carbon::now()->addDay()->format('Y-m-d\TH:i:s')
        };
